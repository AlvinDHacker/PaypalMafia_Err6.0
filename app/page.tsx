        ...
        <div className="mx-auto max-w-2xl py-12">
          <div className="text-center">
            ...
            <p className="dark:text-gray-100 mt-6 text-lg leading-8 text-gray-600">
              Finnovate AI acts as your team's second brain, storing all your files
              and allowing easy vector search.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <SignInButton>
                <Button className="rounded-md bg-[#56b76c] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#32a84d] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                  Get started
                </Button>
              </SignInButton>
            </div>
